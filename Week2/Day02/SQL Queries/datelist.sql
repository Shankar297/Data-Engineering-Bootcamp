...
today AS (
	...
	FROM
		events e
	WHERE
		DATE(CAST(event_time AS TIMESTAMP)) = '2023-01-31'
...
SELECT
	*
FROM
	generate_series(DATE('2023-01-01'), DATE('2023-01-31'), INTERVAL '1 day') as date
...
place_holder_ints AS (
	SELECT
		...
		*
	FROM
		users u CROSS JOIN series
--	WHERE
--		user_id = '14517260138547500000'
)
SELECT
	user_id,
